            ...
            <td class="ext">
                ...
                <div>
                    <div style="text-align: center; margin-top: 10px;">
                        ...
                        <br><br><br><br>
                        <span style="text-decoration: underline; padding: 0px;"><strong>Drs, Fuad. MPA</strong></span><!-- {{ $ppkDetails->nama_staff }} -->
                        <br>
                        <span>NIP. 19741129 199303 1 003</span><!-- {{ $ppkDetails->nip }} -->
                    </div>
                </div>
            </td>
        </tr>
