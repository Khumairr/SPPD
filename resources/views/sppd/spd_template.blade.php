        ...
        <table class="table-content">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br><br>
                    {{ \Carbon\Carbon::parse($sppd->tgl_berangkat)->locale('id')->translatedFormat('d F Y') }}
                    <br><br>
                    {{ \Carbon\Carbon::parse($sppd->tgl_kembali)->locale('id')->translatedFormat('d F Y') }}
                </td>
            </tr>
            <tr>
                <td>8.</td>
            ...
            <div class="tanda-tangan" style="text-align: center;">
                <table class="detail-table">
                    <tr>
                        ...
                        <td>:</td>
                        <td style="text-align: left;">Tangsel</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">Pada Tanggal</td>
                        <td>:</td>
                        <td style="text-align: left;">{{ \Carbon\Carbon::parse($sppd->tgl_spt)->locale('id')->translatedFormat('d F Y') }}</td>
                    </tr>
                </table>
                <br>
                <p style="margin-right: 15px;"><strong>PEJABAT PEMBUAT KOMITMEN</strong></p>
                <br><br><br>
                <p style="margin-right: 15px;"><strong>Drs, Fuad. MPA</strong></p><!-- {{ $sppd->ppk }} -->
